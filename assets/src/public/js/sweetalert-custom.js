...
;(function(window, document, undefined) {
  ...
  sweetAlert = swal = function() {
    ...
    {
      if (modal.getAttribute('data-timer')) {
        modal.getElementsByClassName("countdown")[0].style.display = "none";
  ...
  function setParameters(params) {
    ...
    // Countdown
    modal.setAttribute('data-countdown', params.countdown);

    // Redirection
    modal.setAttribute('data-redirection', params.redirection);
  }
  ...
  function openModal() {
    ...
    var countdown = modal.getAttribute('data-countdown');
    var redirection = modal.getAttribute('data-redirection');
    ...
    if (timer !== "null") {
        ...
        if (countdown == "true") {
            modal.getElementsByClassName("countdown")[0].style.display = "block"; // show countdown
            count = timer / 1000;
            counter = setInterval(setCountdown, 1000); //1000 will  run it every 1 second
            ...
            function setCountdown() {
                ...
                modal.getElementsByClassName("countdown")[0].innerHTML = "Veuillez patienter " + count + " " + seconds;
            }
        }
    }
  }
