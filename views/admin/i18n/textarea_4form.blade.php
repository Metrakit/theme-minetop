...
@foreach( Locale::where('enable','=',1)->get() as $lang )
        <div class="input-group">
            ...
            <textarea class="form-control" type="text" name="{{$field_name}}_{{$lang->id}}" id="{{$field_name}}_{{$lang->id}}">{{{ Input::old($field_name . '_' . $lang->id, (isset($object)?$object->$method_locale($lang->id):null) ) }}}</textarea>
